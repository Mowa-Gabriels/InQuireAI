...
import json
import csv
from src.helpers import llm_pipeline
...
def get_csv(file_path):
    result, qa_list = llm_pipeline(file_path)
    ...
    with open(output_file, "w", newline="", encoding="utf-8") as csvfile:
        ...
        csv_writer.writerow(["QA Pair"])  # Adjust headers as needed

        for qa_pair in qa_list:
            print(qa_pair + "\n-------------------------------------------\n")
            csv_writer.writerow([qa_pair])
